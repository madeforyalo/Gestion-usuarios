                ...
                <form action="carga.php" method=post>
                    <div class="pb-3">
                        <input type="text" name="txtMatricula" id="txtMatricula" placeholder="Matricula"
                            class="form-control shadow" title="Matricula" require >
                    </div>
                    <div class="pb-3">
                        <input type="text" name="txtNombre" id="txtNombre" placeholder="Nombre"
                            class="form-control shadow" title="Nombre" require >
                    </div>
                    <div class="pb-3">
                        <input type="text" name="txtapellido" id="txtapellido" placeholder="apellido"
                            class="form-control shadow" title="Apellido" require >
                    </div>
                    <div class="pb-3">
